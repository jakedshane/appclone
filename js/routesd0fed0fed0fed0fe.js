routes = [
  ...
  },
  {
    ...
    async(routeTo, routeFrom, resolve, reject) {
      var url = 'pages/categorye1ce.html?category='+routeTo.params.category;
  ...
  },
  {
    ...
    // componentUrl: './pages/app.php?app={{this.$route.params.id}}',
    async(routeTo, routeFrom, resolve, reject) {
      var url = 'pages/appb1e6.html?app='+routeTo.params.id;
      // var stringData = routeTo.query;
      // if (stringData.length) {
      //   url = url + "?" + stringData;
      // }
  ...
  },
  {
    ...
    // componentUrl: './pages/app.php?app={{this.$route.params.id}}',
    async(routeTo, routeFrom, resolve, reject) {
      var url = 'pages/exob1e6.html?app='+routeTo.params.id;
      // var stringData = routeTo.query;
      // if (stringData.length) {
      //   url = url + "?" + stringData;
      // }
